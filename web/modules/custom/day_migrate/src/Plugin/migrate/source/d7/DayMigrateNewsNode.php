 ...
 *
 * @MigrateSource(
 *   id = "day_migrate_d7_news_node",
 *   source_module = "node"
 * )
 */
class DayMigrateNewsNode extends Node {
  ...
  public function query(): SelectInterface {
    ...
    $query->where('YEAR(FROM_UNIXTIME(n.created)) = :created', array(':created' => 2022));
//    $query->condition('n.tnid', '799623');
