...
class CustomPageBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  ...
  public function applies(RouteMatchInterface $attributes) {
    ...
    // Disable override breadcrumbs on admin pages.
  ...
  /**
   * Build Breadcrumbs for the add_advert content type nodes.
   *
   * @param \Drupal\Core\Breadcrumb\Breadcrumb $breadcrumb
   */
  private function applyBreadcrumbProduct(Breadcrumb &$breadcrumb, Node $node): void {
    $breadcrumb->addLink(Link::createFromRoute($this->t('Home'), '<front>'));
//    $breadcrumb->addLink(Link::createFromRoute($this->t('Equipment catalog'), 'view.equipment_catalog.page_1'));
