 ...
 *
 * @Block(
 *   id = "day_short_tabs_news_block",
 *   admin_label = @Translation("Day tabs: 6 news item"),
 *   category = @Translation("Custom")
 * )
 */
class ShortTabsNewsBlock extends BlockBase implements ContainerFactoryPluginInterface {
